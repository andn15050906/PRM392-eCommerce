...
public class NhomSanPhamAdapter extends BaseAdapter {
    ...
    private void openDrawableImagePicker(ImageView imgnsp) {
        final String[] imageNames = {"bia", "caphe", "cocktail", "dua", "kem", "nuocngot", "nuoctraicay", "suachua", "trasua", "traxanh"};       AlertDialog.Builder builder = new AlertDialog.Builder(context);
