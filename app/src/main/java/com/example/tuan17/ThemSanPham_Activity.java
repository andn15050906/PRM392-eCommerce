...
public class ThemSanPham_Activity extends AppCompatActivity {
    ...
    private void openDrawableImagePicker() {
        final String[] imageNames = {"bia1","bia2","caphe1", "caphe2","caphe3","cocktail1", "cocktail2","cocktail3","dua1", "kem1","kem2","kem3", "kem4","kem5","nuocngot1","nuocngot2","nuocngot3","nuoctraicay1","nuoctraicay2", "nuoctraicay3","trasua1","trasua2", "traxanh1"};
